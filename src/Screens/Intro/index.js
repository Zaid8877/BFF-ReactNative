    ...
    const renderItem = () => {
        return (
            <View style={styles.wrapper}>
                ...
                <Button text='GET STARTED!' style={{ backgroundColor: 'white',zIndex:10 }} textStyle={{ color: Colors.primary }} onPress={()=>Navigator.navigate('SignIn')} />
            </View>
        )
    }
    return (
        <RootView background={Colors.primary} top={0} bottom={0}>
            <Text style={styles.skip} onPress={()=>Navigator.navigate('SignIn')}>Skip</Text>
